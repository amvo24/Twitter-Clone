  ...
  return (
    <nav className='kjdhsbf2390'>
      ...
      <li className="IconContainer">
        ...
        <div className='ProfileText_09283'>
          <NavLink
            to="/users"
            exact={true}
            className="NavBarLinks"
